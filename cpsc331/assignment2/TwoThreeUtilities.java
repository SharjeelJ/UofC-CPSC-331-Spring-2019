...
public class TwoThreeUtilities<E extends Comparable<E>>
{
    ...
    public boolean isTwoThreeTree(TwoThreeTree<E> T, boolean verbose)
    {
        ...
        return (hasTwoThreeShape(T, verbose) && consistentHeight(T, verbose) && elementsOrdered(T, verbose));
    ...
    public boolean hasTwoThreeShape(TwoThreeTree<E> T, boolean verbose)
    {
        ...
        if (T.root() != null)
        {
            ...
            if ((x.numberChildren() == 0) || (x.numberChildren() == 2) || (x.numberChildren() == 3))
            {
    ...
    private int height(TwoThreeTree<E>.TwoThreeNode x, boolean verbose) throws IllegalArgumentException
    {
    ...
    private void addSubtree(TwoThreeTree<E>.TwoThreeNode x, ArrayList<E> entries)
    {
    ...
    public void testSearch(TwoThreeTree<E> T, E x, boolean success)
    {
    ...
    public void testInsert(TwoThreeTree<E> T, E x, boolean success)
    {
    ...
    public void testDelete(TwoThreeTree<E> T, E x, boolean success)
    {
